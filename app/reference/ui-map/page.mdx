...
| **+ Build new** | Opens the Foundry — Describe → Build by default, or the **Advanced: build step by step** [scaffold wizard](#scaffold-wizard-modal) (kit picker → fields → scaffold) |
