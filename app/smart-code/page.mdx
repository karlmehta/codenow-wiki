...
{/* TODO: add /screenshots/smart-code-local-ollama.png (npm run screenshots; see tools/screenshots/capture.js), then restore the image embed below. Removed for now — the missing asset broke the Nextra build, blocking every wiki deploy since v0.1.37. */}
