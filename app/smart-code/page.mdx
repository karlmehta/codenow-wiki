...
- Run shell commands (like `npm install` or `git commit`) — coming in v0.1.39 with the same approval modal
...
Speculative dual-execution + enterprise harnesses (ServiceNow Build Agent SDK · Salesforce Agentforce DX). See the [v0.1.39 plan in the release notes](/release-notes) once it lands.
